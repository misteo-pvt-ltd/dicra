...
statebase = '/nfsdata/lulc/uttarakhand'
...
boundary_directory = statebase + '/base/Uttarakhand_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid


#file_directory = 'Directory of COG created files'
file_directory = statebase + "/process/cog_lai"

file_name_to_save = 'state_boundaryname_deviance.json'

dppd_tif_name = scriptbase + '/Uttarakhand_state_DPPD.tif'
